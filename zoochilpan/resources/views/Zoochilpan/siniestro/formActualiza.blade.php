    ...
    <script>
        ...
        $(document).ready(function (){
            ...
            if (flag=="Actualizar")  {
                ...
                $.ajax({
                    type: 'get',
                    url: '{!! URL::to('cargarDatosSiniestro')!!}',
                    data: {'id':id},
                    success: function (data) {
                        console.log('exito colega');
                        console.log(data)
                        var idN=data[0].idNecropsia;
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                $("#idNecropsia").empty().append('<option value="' + data[0].id + '">' + data[0].id  +"  "+data[0].diagnosticoMuerte + "  " +data[0].nombrePropio +'</option>');
                                $.ajax({
                                    type:'get',
            ...
            var con= 1;
            $("select[name=idNecropsia]").click(function () {
                var id = $("#idNecropsia").val();
                if (con<=1) {
                    $('#idNecropsia').empty();
                    $.ajax({
                        type: 'get',
                        ...
                        success: function (data) {
                            console.log('exito colega')
                            console.log(data)
                            $("#idNecropsia").append('<option value="0"> Seleciona necropsia</option>');
                            for (var i = 0; i < data.length; i++) {
                                $("#idNecropsia").append('<option value="' + data[i].id + '">' + data[i].id  +"  "+data[i].diagnosticoMuerte + "  " +data[i].nombrePropio +'</option>');
                            }
                        },
