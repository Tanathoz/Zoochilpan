        ...
        $(document).ready(function (){
           var count=0;
            ...
            $("#btnAdd").click(function(event){
                var idClinica=$('input[id=idHojaPro]').val();
                ...
                for (i = 0; i < arregloDeCadenas.length-1; i++) {
                    $.ajax({
                        url: '{!! URL::to('guardarFarmacosClinicos')!!}',
                        headers: {'X-CSRF-TOKEN':CSRF_TOKEN},
                        type:"POST",
                        dataType:'json',
                        data:{idClinica:idClinica,idFarmaco:arregloDatos[paso],dosis:arregloDatos[paso+3],frecuencia:arregloDatos[paso+4],fechaAplicacion:arregloDatos[paso+5]},
